...
* *Container Registry*: link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/registry/configuring-registry-storage[Persistent storage for image registry]
* *Monitoring*: link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/observability/configuring-the-monitoring-stack[Storage for Prometheus and Alertmanager]
* *Logging*: link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/observability/logging-overview[Storage for log aggregation]
...
* *Hardware Requirements*: link:https://docs.redhat.com/en/documentation/red_hat_openshift_data_foundation/4.18/html/planning_your_deployment/planning-your-deployment_rhodf#resource-requirements_rhodf[Minimum 3 worker nodes with local storage]
...
The link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-local[Local Storage Operator] enables the use of local storage devices for persistent volumes in OpenShift 4.18/4.19.
...
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-iscsi[iSCSI]*: Internet Small Computer Systems Interface
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-fibre-channel[Fibre Channel]*: High-speed network technology
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-aws[AWS EBS]*: Amazon Elastic Block Store
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-azure[Azure Disk]*: Microsoft Azure managed disks
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-gce[GCE Persistent Disk]*: Google Cloud persistent disks

==== File Storage Providers
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-nfs[NFS]*: Network File System
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-cephfs[CephFS]*: Ceph File System
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-aws#persistent-storage-aws-efs_persistent-storage-aws[AWS EFS]*: Amazon Elastic File System
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-azure-file[Azure Files]*: Microsoft Azure file shares
...
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/registry/securing-the-registry[Registry Security]*: Configure TLS and authentication
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/registry/registry-overview#registry-integrated-authentication_registry-overview[Access Control]*: Manage registry access permissions
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/registry/configuring-registry-storage[Storage Configuration]*: Optimize storage for registry workloads
...
==== Monitoring Tools
* *link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/observability/monitoring-overview[Prometheus Monitoring]*: Built-in metrics collection
...
=== Design Principles
* *Redundancy*: link:https://docs.redhat.com/en/documentation/red_hat_openshift_data_foundation/4.18/html/planning_your_deployment/planning-your-deployment_rhodf#resource-requirements_rhodf[Implement storage redundancy] across failure domains
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/storage/persistent-storage-local[Persistent storage using local volumes - OpenShift 4.18]
