...
* **Kubernetes 1.32/1.33/1.34**: Latest container orchestration with enterprise support
...
WARNING: OpenShift 4.18 is approaching End of Life. New deployments should target 4.19, 4.20, or 4.21. Always verify current support status at the link:https://access.redhat.com/support/policy/updates/openshift[Red Hat OpenShift Container Platform Life Cycle Policy].
...
* **Assisted Installer**: link:https://docs.redhat.com/en/documentation/assisted_installer_for_openshift_container_platform/2026/[2026 Documentation] - Connected environments
* **Agent-based Installer**: link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing_an_on-premise_cluster_with_the_agent-based_installer/[4.21 Documentation] - Disconnected environments
...
* link:https://docs.openshift.com/container-platform/4.21/[OpenShift 4.21 Documentation] - Current version
* link:https://docs.openshift.com/container-platform/4.20/[OpenShift 4.20 Documentation] - Previous version
* link:https://docs.openshift.com/container-platform/4.19/[OpenShift 4.19 Documentation] - Previous version
* link:https://docs.redhat.com/en/documentation/assisted_installer_for_openshift_container_platform/2026/[Assisted Installer 2026 Documentation] - Connected installations
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing_an_on-premise_cluster_with_the_agent-based_installer/[Agent-based Installer Documentation] - Disconnected installations
* link:https://access.redhat.com/support/policy/updates/openshift[OpenShift Life Cycle Policy] - Support status for all versions
...
=== Advanced Features
* link:https://docs.openshift.com/container-platform/4.21/virt/about-virt.html[OpenShift Virtualization Documentation]
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_ai/[OpenShift AI Documentation]
* link:https://docs.openshift.com/container-platform/4.21/networking/k8s_nmstate/k8s-nmstate-about-the-k8s-nmstate-operator.html[Nmstate Networking Documentation]